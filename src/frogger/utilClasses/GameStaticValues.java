...
public final class GameStaticValues {
    ...
    public static int ROWS_GAP = BLOCK_HEIGHT / 5;

    public static int BLOCK_MAX_MOVE_SPEED = 3;
    ...
    public static int FROG_START_X = BLOCK_WIDTH * MAX_BLOCKS_COUNT_IN_ROW / 2;
     ...
     public static int FROG_START_Y = GameStaticValues.GAME_WINDOW_SIZE.height
             - GameStaticValues.BLOCK_HEIGHT - GameStaticValues.ROWS_GAP;


    public static int FROG_JUMP_DURATION = 30;
    public static int FROG_VERTICAL_MOVE_SPEED = (int)((double)(BLOCK_HEIGHT + ROWS_GAP) / FROG_JUMP_DURATION);
    public static int FROG_HORIZONTAL_MOVE_SPEED = (int)((double)BLOCK_WIDTH / FROG_JUMP_DURATION);
